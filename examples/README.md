...
| `uv run python examples/demo_chelsa.py` | Paper-defined CHELSA over Rwanda: real C3S/CHIRPS, GLO-90 terrain, ERA5 wind/PBL, official exposure, conservation checks, PNG + NetCDF | CDS + CHELSA/GLO-90 HTTP |
